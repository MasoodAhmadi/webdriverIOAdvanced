...
exports.config = {
  ...
  //Google chrome
  hostname: "https://localhost:4444/hub",
  port: 80,
  path: "",

  user: process.env.chrome,
  ...
  //capabile of chrom or firefox at here
  capabilities: [
    {
      maxInstances: 3,
      browserName: "chrome",
  ...
  baseUrl: "https://demo.e-lomake.fi",
  ...
  //service to use for chrome browser only
